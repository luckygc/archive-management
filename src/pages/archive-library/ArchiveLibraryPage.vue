...
const listFields = computed(() =>
    [...fields.value]
        ...
        .sort(
            (current, next) => current.listSortOrder - next.listSortOrder || current.id - next.id,
        ),
);
                ...
                <div class="archive-library-page__advanced-grid">
                    ...
                    >
                                    ...
                                    <el-date-picker
                                        ...
                                        @update:model-value="
                                            (value: string | undefined) =>
                                                (fieldFilter(field).startValue = value)
                                        "
                                    />
                                    <el-date-picker
                                        ...
                                        @update:model-value="
                                            (value: string | undefined) =>
                                                (fieldFilter(field).endValue = value)
                                        "
                                    />
                                </template>
                                <template v-else>
                        ...
                        <el-input
                            ...
                            clearable
                            @update:model-value="
                                (value: string) => (fieldFilter(field).value = value)
                            "
            ...
            <el-table v-loading="loading" :data="rows" height="100%">
                ...
                <el-table-column label="分类" width="150">
                    <template #default="{ row }">{{
                        fixedRowValue(row, "category_name")
                    }}</template>
                </el-table-column>
                ...
                <el-table-column label="操作" width="180" fixed="right">
                    <template #default="{ row }">
                        ...
                        <el-button
                            ...
                            link
                            type="primary"
                            @click="unlockRecord(row)"
                        >
                            解锁
                        </el-button>
                        <el-button v-else link type="primary" @click="lockRecord(row)"
                            >锁定</el-button
                        >
                    </template>
                </el-table-column>
