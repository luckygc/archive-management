...
<template>
    <section class="table-demo-page">
        <section class="table-demo-page__toolbar">
            ...
            <el-button-group>
                <el-button
                    :type="dataSize === 5000 ? 'primary' : 'default'"
                    @click="switchDataSize(5000)"
                >
                    5000 行
                </el-button>
                <el-button
                    :type="dataSize === 12 ? 'primary' : 'default'"
                    @click="switchDataSize(12)"
                >
                    12 行
                </el-button>
            </el-button-group>
                        ...
                        >
                            <div class="table-demo-page__column-menu-item">
                                ...
                                <el-button-group v-if="column.getCanPin()" size="small">
                                    <el-button
                                        :type="
                                            column.getIsPinned() === 'left' ? 'primary' : 'default'
                                        "
                                    ...
                                    <el-button
                                        :type="
                                            column.getIsPinned() === 'right' ? 'primary' : 'default'
                                        "
        ...
        <section ref="tableBodyRef" class="table-demo-page__body">
            ...
            >
                ...
                >
                            ...
                            <template v-else-if="isEditableField(cell.column.id)">
                                <template v-if="isEditingCell(row.original.id, cell.column.id)">
                                    ...
                                    <input
                                        ...
                                        max="9999"
                                        :value="
                                            editingCell?.draftValue ?? String(row.original.pages)
                                        "
                                        @input="
                                            updateEditingDraft(
                                    ...
                                    >
                                        <template #reference>
                                            <button
                                                class="am-table__editable-text is-editing"
                                                type="button"
                                            >
                                                <OverflowTooltipText
                                        ...
                                        <textarea
                                            ...
                                            :value="
                                                editingCell?.draftValue ?? row.original.description
                                            "
                                            @blur="
                                                updateEditingDraft(
                                    ...
                                    <input
                                        ...
                                        type="text"
                                        :value="
                                            editingCell?.draftValue ?? String(cell.getValue() ?? '')
                                        "
                                        @input="
                                            updateEditingDraft(
                                                ($event.target as HTMLInputElement).value,
                    ...
                    <div v-if="tableRows.length === 0" class="am-table__empty">
                        没有符合筛选条件的数据
                    </div>
                </div>
            </div>
