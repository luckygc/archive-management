...
**Reason**: 项目自有审批任务和候选人快照重复了 Flowable 任务与 IdentityLink，且无法承担跨业务统一待办。

**Migration**: 审批活动任务和候选关系改由 Flowable 作为真相源；列表查询改为 `unified-todo` 投影，审批任务创建时按 Flowable 实际候选人投递。
