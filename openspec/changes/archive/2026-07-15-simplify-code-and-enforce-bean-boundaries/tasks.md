...
- [x] 3.2 按业务闭环迁移元数据调用方并删除仅转发的总门面入口
- [x] 3.3 按查询、写入状态和关系用例收缩 ArchiveItemRoutingService
- [x] 3.4 更新相关 Controller、跨模块调用、测试与 ArchUnit 包边界
...
- [x] 6.1 按查询、编辑、电子文件和审计业务区域收缩档案管理页面
- [x] 6.2 按方案、版本、适用范围和绑定业务区域收缩治理页面
- [x] 6.3 检查其余大页面，只提取已有稳定业务边界的组件

## 7. 验证与收尾

- [x] 7.1 运行后端 Spotless、编译、架构测试和完整测试
- [x] 7.2 运行前端 pnpm check、pnpm test 和 pnpm build
- [x] 7.3 按 code-maintainability 规格逐项审计当前源码并更新架构文档
- [x] 7.4 验证 OpenSpec 变更并确认全部任务完成
