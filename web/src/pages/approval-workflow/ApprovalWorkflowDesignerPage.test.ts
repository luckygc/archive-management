...
describe("审批流程设计器页面", () => {
    it("新建流程时载入默认画布并保存完整流程图", async () => {
        ...
        await fireEvent.update(screen.getByPlaceholderText("例如 archive_intake_flow"), "contract_flow");
        ...
        await waitFor(() => expect(approvalApiMocks.createApprovalWorkflowDefinition).toHaveBeenCalled());
