-- Source: Flowable 8.0.0 PostgreSQL create scripts.
-- Managed by Flyway so Flowable runtime must use database-schema-update=false.
-- IDM and Event Registry engines are disabled; only common, process engine, and history tables are created.

-- Source: org/flowable/common/db/create/flowable.postgres.create.common.sql
...
-- Source: org/flowable/db/create/flowable.postgres.create.engine.sql
...
-- Source: org/flowable/db/create/flowable.postgres.create.history.sql
