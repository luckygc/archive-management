...
create table am_authentication_cap_challenge
(
...
create index idx_am_authentication_cap_challenge_expires_at on am_authentication_cap_challenge (expires_at);

comment on table am_authentication_cap_challenge is 'Cap 登录工作量证明挑战表';
comment on column am_authentication_cap_challenge.token is 'Cap challenge token，长度 25 字节随机十六进制';
...
create index idx_am_authentication_cap_token_expires_at on am_authentication_cap_token (expires_at);
